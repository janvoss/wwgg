...
```{r Regeln, echo=T, message=F, warning=F, cache=F, fig.cap="In enger Anlehnung an @voigt_institutionenokonomik_2009"}
...
Der gleiche Zweck kann durch verschiedene (Arten von) Institutionen erreicht werden.
...
$\Rightarrow$ Institutioneller lock-in Effekt möglich.
